...
int lua_cocos2dx_spine_SkeletonAnimation_update(lua_State* tolua_S)
{
    int argc = 0;
    spine::SkeletonAnimation* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_spine_SkeletonAnimation_update'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_number(tolua_S, 2,&arg0, "sp.SkeletonAnimation:update");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_spine_SkeletonAnimation_update'", nullptr);
            return 0;
        }
        cobj->update(arg0);
        lua_settop(tolua_S, 1);
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "sp.SkeletonAnimation:update",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_spine_SkeletonAnimation_update'.",&tolua_err);
#endif
...
int lua_register_cocos2dx_spine_SkeletonAnimation(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"SkeletonAnimation");
        ...
        tolua_function(tolua_S,"update",lua_cocos2dx_spine_SkeletonAnimation_update);
